...
export default function HomePageClientComponent({
  ...
  // means something went wrong in the server component for fetching
  // the business profile for current user
  if (!businessDetails) {
    toast(
      "Something went wrong fetching business profile. Please try again later.",
      {
        autoClose: 3000,
        type: "error",
        position: "bottom-right",
